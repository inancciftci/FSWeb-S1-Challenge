...
function fenomenEkle(arr, number, profile, followers, posts, platform) {
  const copyArr = [...arr];
  const obj = { number, profile, followers, posts, platform };
  copyArr.push(obj);
  return copyArr;
}
...
// function platformaGoreCokGonderiYapanFenomen(arr, platform) {
//   const filteredByPlatform = arr.filter((val) =>
//     val.platform.includes(platform)
//   );
//   const sortedByPosts = filteredByPlatform.sort((a, b) => {
//     return a.posts - b.posts;
//   });
//   return sortedByPosts[sortedByPosts.length - 1].profile;
// }
/* ***** GÖREVLERİN SONU ***** */
